            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  // Form Başlığı
                  Text(
                    isEditing ? 'Hesap Bilgilerini Düzenle' : 'Yeni Hesap Oluştur',
                    style: Theme.of(context).textTheme.headlineSmall?.copyWith(
                          fontWeight: FontWeight.bold,
                  ...
                  Obx(() {
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        ElevatedButton.icon(
                          onPressed:
                              controller.isSubmitting.value ? null : () => controller.saveAccount(),
      ...
      children: [
        ...
        Obx(() => Row(
              children: controller.accountTypes.map((type) {
                ...
                final (String label, IconData icon, Color color) = _getAccountTypeInfo(type);
